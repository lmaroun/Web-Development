				...
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
						...
						<div class = "form-group">
							...
							<input style = "margin-top: 20px;" type = "file" required = "required" id = "photo" name = "photo" />
						</div>
						<br />
						<div class = "form-group">
							<button name = "add_room" class = "btn btn-info form-control"><i class = "glyphicon glyphicon-save"></i> Save</button>
							<p style = "text-align: center;  margin-top: 20px; font-weight: bold;"><a href="index.php">Cancel</a></p>
						</div>
					</form>
